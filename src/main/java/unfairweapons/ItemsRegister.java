...
import unfairweapons.items.armour.SuperconductorArmourMaterial;
...
public class ItemsRegister {
    ...
    public static final ToolMaterial CLAYMORE_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 2031, 9.0F, 20.0F, 15, ItemTags.NETHERITE_TOOL_MATERIALS);
    public static final ToolMaterial CYBER_CUTLASS_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 2031, 9.0F, 15.0F, 15, ItemTags.NETHERITE_TOOL_MATERIALS);
